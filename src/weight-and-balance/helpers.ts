 ...
 */
export function calculateArm(emptyResult: WeightAndBalanceMoment, withObjectResult: WeightAndBalanceMoment): number {
    ...
    // Equation 26
    const xp =
        (withObjectResult.arm * withObjectResult.weight - emptyResult.arm * emptyResult.weight) /
        objectWeightDifference;
